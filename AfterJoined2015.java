package Java8.CollectionPracticeSet;

import java.util.ArrayList;

public class AfterJoined2015 {
    ...
    public AfterJoined2015(int id, String name, int age, String gender, String department, int yearOfJoining,
                                    double salary) {
        this.id = id;
        this.name = name;
        this.age = age;
    ...
    public static void main(String[] args) {
        ...
        ArrayList<String> joinedAfter2015= new ArrayList<>();

        for (Employee1 E :employeeList){
            if (E.getYearOfJoining() > 2015){

                joinedAfter2015.add(E.getName());
            }
        }
        System.out.println("Joining After 2015 : -");

        for (String name : joinedAfter2015){
